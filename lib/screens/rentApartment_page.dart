...
class RentApartmentPage extends StatefulWidget {
  @override
  _RentApartmentPageState createState() => _RentApartmentPageState();
}

String value1 = 'Посуточно';
String value2 = 'Количество комнат';

class _RentApartmentPageState extends State<RentApartmentPage> {
  @override
